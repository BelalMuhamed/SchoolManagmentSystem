...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("School.Modules.Class", b =>
                {
            ...
            modelBuilder.Entity("School.Modules.Degree", b =>
                {
            ...
            modelBuilder.Entity("School.Modules.Subject", b =>
                {
            ...
            modelBuilder.Entity("School.Modules.Teacher", b =>
                {
            ...
            modelBuilder.Entity("School.Modules.TeacherAttendance", b =>
                {
            ...
            modelBuilder.Entity("School.Modules.TeacherClassSubject", b =>
                {
                    ...
                    b.HasKey("date", "Lesson", "classId", "TeacherId");
            ...
            modelBuilder.Entity("School.Modules.Class", b =>
                {
                    b.HasOne("School.Modules.Teacher", "Manager")
                        .WithMany("Classes")
            ...
            modelBuilder.Entity("School.Modules.Degree", b =>
                {
                    ...
                    b.HasOne("School.Modules.Subject", "subject")
                        .WithMany("studentdegrees")
                        .HasForeignKey("SubId");
            ...
            modelBuilder.Entity("School.Modules.Student", b =>
                {
                    b.HasOne("School.Modules.Class", "Class")
                        .WithMany("Students")
            ...
            modelBuilder.Entity("School.Modules.TeacherAttendance", b =>
                {
                    b.HasOne("School.Modules.Teacher", "teacher")
            ...
            modelBuilder.Entity("School.Modules.TeacherClassSubject", b =>
                {
                    ...
                    b.HasOne("School.Modules.Class", "classs")
                        .WithMany("lesson")
                        .HasForeignKey("classId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
